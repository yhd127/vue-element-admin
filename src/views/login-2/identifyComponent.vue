<template>
    ...
    <el-form-item label="验证码">
      <div class="code" @click="refreshCode" style="cursor: pointer;" title="点击切换验证码">
        <s-identify :identifyCode="identifyCode"></s-identify>
      </div>
      <el-input v-model="userInput" placeholder="请输入验证码"></el-input>
    </el-form-item>
    <el-form-item>
      <el-button type="primary" @click="checkCode">验证</el-button>
    </el-form-item>
    <el-form-item v-if="isCodeCorrect">
      <el-alert type="success" title="验证码正确"></el-alert>
    </el-form-item>
    <el-form-item v-else>
      <el-alert type="error" title="验证码错误"></el-alert>
    </el-form-item>
  </el-form>
  </template>
